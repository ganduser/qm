...
\[
\frac{\hat{p}^2}{2m}\ket{\psi} = E \ket{\psi} \quad \implies \quad \psi''(x) = -\frac{2m}{\hbar^2} E \psi(x),
\]
mentre nella regione II 
\[
\left( \frac{\hat{p}^2}{2m} + V_0 \right) \ket{\psi} = E \ket{\psi} \quad \implies \quad \psi''(x) = \frac{2m}{\hbar^2}(V_0 - E) \psi(x).
\]
