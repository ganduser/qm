...
Se vale
\[
O \ket{e_i} = \lambda_i \ket{e_i} \quad \implies \quad \braket{e_i|O|e_i} = \lambda_i \braket{e_i|e_i}\quad \implies
\]
\[
\quad \implies \qquad \lambda_i = \frac{\braket{e_i|O|e_i}}{\braket{e_i|e_i}}
\]
\[
\lambda_i^* = \frac{\braket{e_i|O^\dag|e_i}}{\braket{e_i|e_i}} = \frac{\braket{e_i|O|e_i}}{\braket{e_i|e_i}} = \lambda_i \quad \implies \quad \lambda_i \in \mathbb{R}
\]
Se invece vale
\[
...
Poiché invece
\[
O \ket{e_i^{(a)}} = \lambda_i \ket{e_i^{(a)}} \quad \implies \quad O \left( \sum_a c_a \ket{e_i^{(a)}} \right) = \sum_a c_a O \ket{e_i^{(a)}} \quad \text{etc.}
\]
