...
\begin{align*}
a \ket{0} &= 0 \text{ \`e l'equazione che devo risolvere.} \\
\braket{x|n} &= \psi_n(x)
\end{align*}
\begin{align*}
...
\]
cio\`e \`e una gaussiana e rappresenta \textbf{lo stato fondamentale dell'atomo di idrogeno}.
...
\]
dove \( H_n \) \`e un potenziale di grado \( n \). Sono i polinomi di Hermite.