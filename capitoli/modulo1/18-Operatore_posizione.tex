...
\braket{x'|\psi} = \psi(x')
\end{cases} \quad \implies \quad \psi(x') = \int_{-\infty}^{+\infty} \braket{x'|x} \braket{x|\psi} \, dx \quad \implies
\]
\[
\implies \quad \psi(x') = \int_{-\infty}^{+\infty} \braket{x'|x} \psi(x) \, dx
\]
...
\[
\int_{-\infty}^{+\infty} \delta(ax) \psi(x) \, dx = \left[ ax = t \; \implies \; dx = \frac{dt}{a} \right] = 
\]
\[
...
\( \braket{x|\mathcal{P}|\psi} = \psi(-x) \) con \( \braket{x|\psi} = \psi(x) \implies \bra{x} \mathcal{P} = \bra{-x} \).
\begin{align*}
...
&= \psi(-x)
\end{align*}
quindi \( \mathcal{P} \) è hermitiano \( \implies \mathcal{P} \ket{x} = \ket{-x} \implies \mathcal{P}^2 \ket{x} = \ket{x} \implies \mathcal{P}^2 = \mathbbm{1} \implies \mathcal{P} \mathcal{P} = \mathcal{P}^\dag \mathcal{P} = \mathbbm{1} \implies \mathcal{P} \) è unitario. \( \mathcal{P}^2 = \mathbbm{1} \implies \) autovalori \( \pm 1 \).
...
- \varphi_{-}(x) \\
\varphi_{-}(-x)
\end{cases} \quad \implies \quad \varphi_{-} \text{ funzione dispari}
\]
\[
\braket{x|\mathcal{P}|\varphi_{+}} = \begin{cases}
\varphi_{+}(x) \\
\varphi_{+}(-x)
\end{cases} \quad \implies \quad \varphi_{+} \text{ funzione pari}
\]
\[
