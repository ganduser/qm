...
\end{align*}
Quindi passo da \( S \) ad \( H \) e nel primo l'operatore è costante nel tempo ed evolvono gli stati, nel secondo è il contrario.
...
ma so che
\[
i \hbar \frac{\partial S}{\partial t} = \mathcal{H} S \; \implies \; -i \hbar \frac{\partial S^\dag}{\partial t} = S^\dag \mathcal{H}^\dag \; \implies \; -i \hbar \frac{\partial S^{-1}}{\partial t} = S^{-1} \mathcal{H}
\]
quindi 
\[
\frac{d}{dt} A^H(t) = -\frac{1}{i \hbar} S^{-1} \mathcal{H} A^S S + S^{-1} A^S \frac{\mathcal{H} S}{i \hbar} + \frac{\partial}{\partial t} A^H(t).
\]
Poiché per definizione \( S(t, t_0) A^H(t) = A^S(t_0) S(t, t_0) \), ho
\begin{align*}
...
\end{align*}
però \( A^H = S^{-1} A^S S \) e \( A^H \mathcal{H}^H = S A^S S S^{-1} \mathcal{H} S = S A^S \mathcal{H} S \)
\[
...
\]
Esempio: \( A \) e \( B \) costanti del moto \( \implies [A, B] \) costante del moto. Infatti
\[
[A, \mathcal{H}] = [B, \mathcal{H}] = 0 \quad \implies \quad \left[ [A, B], \hat{\mathcal{H}} \right] = 0.
\]