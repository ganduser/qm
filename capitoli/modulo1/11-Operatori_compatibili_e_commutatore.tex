...
Dimostrazione: caso non degenere (\(\lambda_i \neq \lambda_j\)).
...
\end{align*}
\[
0 = \braket{e_i|\left[ A, B \right]|e_k} = \braket{e_i|B|e_k} \left( \lambda_i - \lambda_k \right) \quad \Rightarrow \quad  \braket{e_i|B|e_k} = 0
\]
cio\`e \(B\) \`e diagonale con autovettore \(\ket{e_k}\), infatti
\[
...
\[
U = \sum_{k = 0}^\infty \frac{1}{k!} \left( iH \right)^k \qquad \Rightarrow \qquad U^\dag = \sum_{k = 0}^\infty \frac{1}{k!} \left[ \left( iH \right)^k \right]^\dag
\]
