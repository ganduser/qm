...
$$
non posso normalizzare in senso proprio. Coerentemente con le autofunzioni della posizione, ho $ \braket{k|k^\prime} = \delta(k - k^\prime) $, cio\`e
\begin{align*}
...
$$
quindi analogo ad $ U^\dag U = \mathbbm{1} $, cio\`e matrici di cambio di base
$$
