...
Prendo due operatori \(A\) e \(B\) hermitiani applicati allo stato \(\ket{\psi}\). Allora
\[
...
Quindi
\[
\braket{\beta|\alpha} = z \braket{\beta|\beta} \quad \implies \quad z = \frac{\braket{\beta|\alpha}}{\braket{\beta|\beta}}
\]
Calcolo
\begin{align*}
...
\]
\[
x = \braket{\psi|\frac{1}{2}\{A,B\}|\psi} \qquad \implies \qquad x^* = \dots
\]
\[
y = \braket{\psi|\frac{1}{2}[A,B]|\psi} \qquad \implies \qquad (iy)^* = \dots
\]
Quindi
\[
